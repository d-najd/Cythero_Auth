...
data class AnalyticsTable(
    ...
    @SerializedName("Total Time Played") val totalTimePlayed: List<Double>,
    @SerializedName("Total Time Spent") val totalTimeSpent: List<Double>,
...
private const val TESTING_ANALYTICS_CALCULATED =
            "         {\n" +
            "            \"Average Paint\": 193.6571052631579,\n" +
            "            \"Average Time\": 2.65478947368421,\n" +
            "            \"Least Paint\": 3.995,\n" +
...
private const val TESTING_ANALYTICS_TABLE_JSON =
            "        {\n" +
            "            \"Base Good Coverage\": [\n" +
            "                30.15193,\n" +
            "                9.803279,\n" +
